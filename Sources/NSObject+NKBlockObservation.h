...
typedef void(^NKWithObjectBlock)(id obj, id arg);
typedef void(^NKObservationBlock)(id obj, NSDictionary *change);
typedef void(^NKKeyValueBlock)(id key, id obj);

@interface NSObject (NKBlockObservation)
